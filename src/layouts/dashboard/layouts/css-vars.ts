...
export function managerLayoutVars(theme: Theme) {
  return {
    ...
    '--layout-manager-content-pt': theme.spacing(1),
    '--layout-manager-content-pb': theme.spacing(1),
    '--layout-manager-content-px': theme.spacing(2),
  };
}

// ----------------------------------------------------------------------

export function managerNavColorVars(
  theme: Theme,
