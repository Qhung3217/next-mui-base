...
export const FORMAT_PATTERNS = {
  dateTime: 'DD MMM YYYY HH:mm', // 17 Apr 2022 13:00
  date: 'DD MMM YYYY', // 17 Apr 2022
  time: 'HH:mm', // 13:00
  split: {
    dateTime: 'DD/MM/YYYY HH:mm', // 17/04/2022 13:00
...
export function getDateRanges() {
  ...
  const ranges = {
    ...
    last7Days: {
      start: sevenDaysAgo.startOf('day').toDate(),
      end: now.endOf('day').toDate(),
    },
    thisMonth: {
    ...
    lastMonth: {
      start: startOfLastMonth.toDate(),
      end: endOfLastMonth.endOf('day').toDate(),
    },
  };
