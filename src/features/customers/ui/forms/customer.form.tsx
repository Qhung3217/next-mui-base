...
import { useGetCustomer } from '../../queries';
import { useCustomerFormController } from '../../hooks';
import {
  CustomerNameField,
  CustomerCodeField,
  CustomerNoteField,
...
const CustomerFormDialog = ({
  ...
  const { data: customerGroup, isLoading: loading } = useGetCustomer(recordIdProp, {
  ...
  const { methods, handleSubmit: handleFormSubmit } = useCustomerFormController({
