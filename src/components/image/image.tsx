...
export const Image = forwardRef<HTMLSpanElement, ImageProps>((props, ref) => {
  const {
    ...
    placeholderImage = defaultImage.image,
    ...other
  } = props;
  ...
  const renderComponents = {
    ...
    image: () => (
      <ImageImg
        src={withServerUrl(src) || placeholderImage}
        alt={alt}
...
export const defaultImage = {
  branch: '/assets/images/default-branch.png',
  image: '/assets/images/placeholder.svg',
  product: '/assets/images/image-default.png',
};
